...
```r
install.packages("C:/Users/you/Downloads/hplcAnalyzer_0.5.3.tar.gz",
                 repos = NULL, type = "source")
```

On macOS the path looks like `/Users/you/Downloads/hplcAnalyzer_0.5.3.tar.gz`. Use forward
