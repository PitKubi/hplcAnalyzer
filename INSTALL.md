...
```r
install.packages("C:/Users/you/Downloads/hplcAnalyzer_0.5.2.tar.gz",
                 repos = NULL, type = "source")
```

On macOS the path looks like `/Users/you/Downloads/hplcAnalyzer_0.5.2.tar.gz`. Use forward
